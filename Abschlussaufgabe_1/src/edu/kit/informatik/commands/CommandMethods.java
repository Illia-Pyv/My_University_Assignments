...
public interface CommandMethods {
     ...
     *                       execute
     * @param networkManager this is the Network Manager object that is needed to
     ...
     */
    Result execute(String parameters, NetworkManager networkManager) throws InvalidParametersException;
