...
/**
 * This class describes a command to list the mail of a customer.
 * 
 * @author Lucas Alber
 * @version 1.0
 */
public class ListMail extends RestrictedCommand {

    private static final String REGEX_LIST_MAIL = "list-mail";
     ...
     */
    public ListMail(final PostSystem postSystem) {
        super(postSystem);
    ...
    protected Result execute(final ParameterBundle bundle) throws PostSystemException {
        ...
        final Map<PostalService, Integer> mail = customer.getReceivedMail();
